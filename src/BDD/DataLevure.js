export const Levure = [
  {
    ...
    impactMethane: 6,
    typeDeGaz: "Methane",
    ProductionMethane: 94,
    ProductionMethaneText: "90%",
    type: "Qualité lait",
    impactLait:95,
    impactLaitText: "5%",
